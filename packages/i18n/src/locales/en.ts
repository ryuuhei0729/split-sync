...
const en: TranslationShape = {
  ...
  planComparison: {
    ...
    valueExportPremium: "Unlimited",
    valueResolutionGuest: "720p",
    valueResolutionFree: "720p",
    valueResolutionPremium: "All",
    valueSplitsGuest: "1",
    valueSplitsFree: "Unlimited",
    valueSplitsPremium: "Unlimited",
    valueWatermarkGuest: "Yes",
    valueWatermarkFree: "Yes",
    valueWatermarkPremium: "None",
    valueAdsGuest: "Yes",
    valueAdsFree: "Yes",
    valueAdsPremium: "None",
  },

  planFeature: {
    title: "Plan Features",
    export: "Export",
    exportGuestValue: "1/day",
    exportFreeValue: "Unlimited",
    exportPremiumValue: "Unlimited",
    resolution: "Resolution",
    resolutionGuestValue: "720p",
    resolutionFreeValue: "720p",
    resolutionPremiumValue: "All resolutions",
    splits: "Splits",
    splitsGuestValue: "1",
